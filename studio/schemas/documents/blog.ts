...
const blog = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Published at',
      description:
        'You can use this field to schedule blog where you show them',
      type: 'datetime',
      group: 'meta',
      validation: (Rule) => Rule.required()
    }),
    ...
    defineField({
      ...
      title: 'Excerpt',
      description:
        'This ends up on summary pages, when people share your blog in social media.',
      group: 'excerpt',
      validation: (Rule) => Rule.required()
    }),
    defineField({
      ...
      description: 'Image that is displayed in blogs lists',
      group: 'excerpt',
      type: 'mainImage'
    }),
    defineField({
